...
# Yellow: Low Risk
# Green: No Risk 
def social_distancing_view(frame, distances_mat, boxes, risk_count, withMask, noMask):
    ...
    pad = np.full((200,frame.shape[1],3), [110, 110, 100], dtype=np.uint8)
    ...
    cv2.putText(pad, "Bounding box shows if a person wears a mask.", (50, 130),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (100, 100, 0), 2)
    cv2.putText(pad, "NO MASK : " + str(noMask) + " people", (50, 160), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 255), 1)
    cv2.putText(pad, "WITH MASK : " + str(withMask) + " people", (50,  180), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255,0,0), 1)
